...
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${CYAN}Prochaine etape - Lancez le service :${NC}"
echo ""
echo -e "  ${BOLD}./.uly/integrations/cloudflare-tunnel/run.sh${NC}"
echo ""
echo -e "  ${DIM}L'URL publique du tunnel s'affichera au demarrage.${NC}"
echo ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${CYAN}Configuration N8N (apres demarrage) :${NC}"
echo ""
echo "  1. Methode : POST"
echo "  2. URL : [URL_TUNNEL]/ask"
echo "  3. Header : Authorization = Bearer [TOKEN]"
echo "  4. Body : {\"message\": \"votre question\"}"
echo ""
echo -e "${GREEN}Lancez run.sh pour obtenir votre URL publique !${NC}"
echo ""
